<template>
    <div class="layout" :class="{ 'layout--sidebar-open': sidebarOpen }">
        ...
        <AppHeader class="layout__header" :sidebar-open="sidebarOpen" @toggle-sidebar="sidebarOpen = !sidebarOpen" />

        <aside class="layout__sidebar" aria-label="Боковое меню">
            <div class="sidebar__header">
                <SidebarBrand :account-name="accountName" />
            </div>

            <nav class="sidebar__nav" aria-label="Основная навигация">
                <div
                    class="sidebar__block"
                    :aria-current="$route.name === ROUTES.REVIEWS ? 'page' : undefined"
                >
                ...
                <RouterLink
                    ...
                    class="sidebar__link"
                    :class="{ 'sidebar__link--active': $route.name === ROUTES.REVIEWS }"
                    @click="sidebarOpen = false"
                >
                    Отзывы
                </RouterLink>
                ...
                <RouterLink
                    ...
                    class="sidebar__link"
                    :class="{ 'sidebar__link--active': $route.name === ROUTES.SETTINGS }"
                    @click="sidebarOpen = false"
                >
                    Настройка
                </RouterLink>
...
import SidebarBrand from '@/components/layout/sidebar/SidebarBrand.vue';
...
const accountName = computed(() => auth.user?.name || auth.user?.email || 'Аккаунт');
